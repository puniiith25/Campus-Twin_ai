...
import { BookOpen, Users, Award, Microscope, Briefcase, Clock, CheckCircle2, Sparkles } from "lucide-react";
import { formatHours } from "@/lib/utils";

export function PathTimeline({ path, onSelectStep, showWhatIfButton = true, onLaunchWhatIf }) {
