...
export function ComparisonView({ pathA, pathB }) {
  ...
  const chartData = [
    { subject: "Goal Match", PathA: pA.metrics?.goal_alignment || 0, PathB: pB.metrics?.goal_alignment || 0 },
    { subject: "Research", PathA: pA.metrics?.research_exposure || 0, PathB: pB.metrics?.research_exposure || 0 },
    { subject: "Networking", PathA: pA.metrics?.networking_value || 0, PathB: pB.metrics?.networking_value || 0 },
    { subject: "Industry", PathA: pA.metrics?.industry_exposure || 0, PathB: pB.metrics?.industry_exposure || 0 },
    { subject: "Faculty", PathA: pA.metrics?.faculty_interaction || 0, PathB: pB.metrics?.faculty_interaction || 0 },
    { subject: "Overall Score", PathA: pA.metrics?.overall_score || 0, PathB: pB.metrics?.overall_score || 0 },
  ];
