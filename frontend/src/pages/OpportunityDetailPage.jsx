...
import { Clock, CheckCircle2, ArrowLeft, Sparkles, UserCheck } from "lucide-react";
...
export default function OpportunityDetailPage() {
  ...
  if (error || !item) {
    return (
      <div className="max-w-4xl mx-auto px-4 py-12">
        ...
        <Link to="/opportunities" className="mt-4 inline-flex items-center text-xs font-semibold text-brand-600">
  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 space-y-8">
      <Link to="/opportunities" className="inline-flex items-center text-xs font-semibold text-slate-500 hover:text-brand-600 transition-colors">
        <ArrowLeft className="w-3.5 h-3.5 mr-1" /> Back to directory
      </Link>
