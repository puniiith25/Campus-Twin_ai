        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li><Link href="/explore" className="hover:text-brand-300 transition-colors">Explore Chat</Link></li>
              <li><Link href="/path" className="hover:text-brand-300 transition-colors">Visual Journey Path</Link></li>
              <li><Link href="/what-if" className="hover:text-brand-300 transition-colors">What-If Scenario Simulator</Link></li>
              <li><Link href="/compare" className="hover:text-brand-300 transition-colors">Path Comparison</Link></li>
              <li><Link href="/opportunities" className="hover:text-brand-300 transition-colors">Opportunity Directory</Link></li>
            </ul>
          </div>
