...
import { Clock, BookOpen, CheckCircle2, ArrowRight, Award, Users, Microscope } from "lucide-react";
import Link from "next/link";
import { formatHours } from "@/lib/utils";

interface OpportunityCardProps {
  item: OpportunityItem;
  onAddToPath?: (item: OpportunityItem) => void;
}

export function OpportunityCard({ item, onAddToPath }: OpportunityCardProps) {
